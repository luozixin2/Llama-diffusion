...
void llama_kv_cache::set_input_kq_mask(
        ...
        bool causal_attn, 
        uint32_t block_size) const {  // 新增参数
...
// }
void llama_kv_cache_context::set_input_kq_mask(
        ggml_tensor * dst, 
        const llama_ubatch * ubatch, 
        bool causal_attn, 
        uint32_t block_size) const {  // 新增参数
    
    kv->set_input_kq_mask(dst, ubatch, causal_attn, block_size);
}
